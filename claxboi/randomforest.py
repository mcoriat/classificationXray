"""
Experimental Random Forest classifier for X-ray source classification.

Alternative to the Naive Bayes approach in classify_new.py. Uses scikit-learn
RandomForestClassifier with max_depth=12 and optional SMOTE oversampling.
Supports both train/test split mode and full catalog prediction.
"""
...
if __name__ == "__main__":
    ...
    for f in list(X.columns):
        try:
            ...
            print(f"Skipping non-numeric column: {f}")
